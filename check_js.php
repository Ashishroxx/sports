...
<form action="home.php" method="post">
 ...
 <h1 align="center" style="color:white;"><?php echo "total no of attempt ques=   " .$count. "<br>";?></h1>
...
echo '<script> alert("your score is 0, you did not attempt any question."); window.location.replace("js.php");</script>';
}
	}
